    ...
    return (
        <form className={"add-form"} onSubmit={onUpdate}>
            <label className="label-input-field">
                <h1>Add more activity emissions to your trip</h1>
                <h3 className="label-input-update"> Rounds of Golf:</h3>
            ...
            <label className="label-input-field">
                <h3 className="label-input-update"> Skiing Days:</h3>
                <input className="number-field"
                       type="number"
                       placeholder="Add additionalSkiing days" min="0"
                       step="1"
                       value={amountOfSkiingDays}
                       onChange={event => setAmountOfSkiingDays(Number(event.target.value))}/>
            </label>
            <label className="label-input-field">
                <h3 className="label-input-update"> Beauty Days:</h3>
                <input className="number-field"
                       type="number"
                       placeholder="Add additional Spa and Wellness days"
                       min="0" step="1"
                       value={amountOfBeautyDays}
                       onChange={event => setAmountOfBeautyDays(Number(event.target.value))}/>
            </label>
            <label className="label-input-field">
                <h3 className="label-input-update"> Custom Activity Item:</h3>
                <input className="text-field"
                       type="customActivityItem"
                       placeholder="Add additional Custom Activity Item"
                       value={customActivityItem}
                       onChange={event => setCustomActivityItem(event.target.value)}/>
            </label>
            <label className="label-input-field">
                <h3 className="label-input-update"> Amount of Custom Activity Item: </h3>
                <input className="number-field"
                       type="number"
            ...
            <label className="label-input-field">
                <h3 className="label-input-update"> Emissions of Custom Activity Item:</h3>
                <input className="number-field"
                       type="number"
