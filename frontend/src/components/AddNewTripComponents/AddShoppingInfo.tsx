...
export default function AddShoppingInfo({
    ...
    return (
        <div className={"add-trip-shopping"}>
            <label className="label-input-field"> Number of Clothing Items: <input className="number-field"
                                                                                   type="number"
            ...
            <label className="label-input-field">Number of Electric Items: <input className="number-field"
                                                                                  type="number"
            ...
            <label className="label-input-field">Number of Souvenirs: <input className="number-field"
                                                                             type="number"
            ...
            <label className="label-input-field">Custom Shopping Item: <input className="text-field"
            ...
            <label className="label-input-field"> Amount of Custom Shopping Item: <input className="number-field"
                                                                                         type="number"
            ...
            <label className="label-input-field"> Emissions of Custom Shopping Item: <input className="number-field"
                                                                                            type="number"
