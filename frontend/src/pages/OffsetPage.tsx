    ...
    return (
        <div className={"offset-page"}>
            ...
            <div className={"project-page-header"}>
                <p> To compensate your emissions of <span
                    className={"value-field"}>{trip.calculatedEmissions.totalEmissions} kg CO<sub>2</sub>-eq</span>
            ...
            <div className={"project-card"}>
                ...
                <div className={"project-text"}>
                    ...
                    <p>Est. Reductions: 730.457 t CO<sub>2</sub>-eq</p>
                    <p>The project activity generates electricity using solar energy. The
            ...
            <div className={"project-card"}>
                ...
                <div className={"project-text"}>
                    ...
                    <p>Est. Reductions: 22.668 t CO<sub>2</sub>-eq</p>
                    <p>The Dachunhe Sanji hydro project utilizes water resources from the
                        Dachunhe River to generate electricity, which will be delivered to the China Southern Power Grid
                        without CO2 emissions..</p>
                </div>
            ...
            <div className={"project-card"}>
                ...
                <div className={"project-text"}>
                    ...
                    <p>Est. Reductions: 10.000 t CO<sub>2</sub>-eq</p>
                    <p>The project aims to disseminate over 8,000 improved energy efficient
                ...
                <a className={"project-link"}
                   href="https://www.carbonfootprint.com/gs_ver_malawi_cookstove_carbon_offset.html">
                    More information</a>
            ...
            <div className={"project-card"}>
                ...
                <div className={"project-text"}>
                    ...
                    <p>Est. Reductions: 6.000 t CO<sub>2</sub>-eq</p>
                    <p>The Borehole project is a micro project in Rwanda, providing a source
                        of clean drinking water to a local community.
                        The project is based around the supply of clean water to local communities in Rwanda through the
